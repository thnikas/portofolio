...
export default function Laptop() {//3d model in hero page
  ...
  return (
    <web.main style={{width:isSmallDevice?300:550, height:isSmallDevice?300:550,marginLeft:isSmallDevice?"0%":'55%', paddingTop:isSmallDevice?"0%":'5%'}} >
      <web.h1 style={{ opacity: props.open.to([0, 1], [1, 0]), transform: props.open.to((o) => `translate3d(-50%,${o * 50 - 100}px,0)`) }}>click</web.h1>
      <Canvas dpr={[1, 2]} camera={{ position: [0, 0, -30], fov: 35 }} style={{top:isSmallDevice?'108%':0,left:isSmallDevice?'12%':0}}>
        <three.pointLight position={[10, 10, 10]} intensity={1.5} color={props.open.to([0, 1], ['#f0f0f0', '#d25578'])} />
        <Suspense fallback={null} >
          <group rotation={[0, Math.PI, 0]} onClick={(e) => (e.stopPropagation(), setOpen(!open))}>
            <Model open={open} hinge={props.open.to([0, 1], [1.575, -0.425])} scale={[1.2, 1.2, 1.2]}/>
          </group>
